...
const Adminstudent3 = () => {
  const { data, loading } = AxiosAdmin(
    "http://localhost:4354/students_junior_3"
  );
    ...
    <section >
     ...
     <>
      <div className="card col-md-10 mx-auto text-light my-3 p-2 bg-primary">
        <p className="fw-bold fs-4 m-0 text-capitalize">junior secondary student 3</p>
                ...
                <tr key={index} className="text-center">
                  ...
                  <td>
                    <Link
                      ...
                      to={`/adminviewthreestudent/${element.id}`}
                    >
                      {" "}
                      Edit / View /Delete{" "}
                    </Link>
        ...
        <p className="fw-bold fs-5 text-capitalize">total number of junior secondary student 3 = {data.length}</p>
