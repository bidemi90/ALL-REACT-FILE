...
const Adminstudent1 = () => {
  const { data, loading } = AxiosAdmin(
    "http://localhost:4354/students_junior_1"
  );
    ...
    <section >
     ...
     <>
      <div className="card  col-md-10 mx-auto text-light my-3 p-2 bg-primary">
        <p className="fw-bold fs-4 m-0 text-capitalize">junior secondary student 1</p>
      ...
      <div className="card col-12 mx-auto my-2  bg-primary">
                ...
                <tr key={index} className="text-center">
                  ...
                  <td>
                    <Link
                      ...
                      to={`/adminviewonestudent/${element.id}`}
                    >
                      {" "}
                      Edit / View /Delete{" "}
                    </Link>
        ...
        <p className="fw-bold fs-5 text-capitalize">total number of junior secondary student 1 = {data.length}</p>
